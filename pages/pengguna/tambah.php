...
<div class="card border-info mb-3">
    <div class="card-header bg-info text-white">Tambah Warga</div>
    <div class="card-body">
        <form method="post">
            ...
            <div class="form-group">
                ...
                <small>
                    Tidak boleh menggunakan spasi, huruf kecil semua, username tidak boleh sama. <br> Contoh : Ibra,ibra761,vincent_.
                </small>
            </div>
            ...
            <div class="form-group">
                ...
                <small>
                        Contoh  : Tangerang,Jl.Binong Permai Rt/Rw: 03/01
                </small>
            </div>
