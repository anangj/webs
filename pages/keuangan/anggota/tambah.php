...
?>
<!-- Untuk Member -->
<h1>Kelola Keuangan Siswa  </h1>
<hr>

<div class="card border-info mb-3">
    <div class="card-header bg-info text-white">Tambah Data Keuangan Warga</div>
    <div class="card-body">
        <form method="post">
                ...
                <div class="row">
                    <div class="col-sm-6">
                       <select class="form-control" name="user" required>
                           <option value="">~ Username Siswa ~</option>
                ...
                if( $tgl == "" || $status == "" || $keterangan == "" || $jumlah == ""){
                    ...
                    try {
                        ...
                        <script>
                            ...
                            window.location.href='?page=keuanganWarga';
                        </script>
                    ";
                    }catch(Exception $e){
                        echo $e->getMessage();
