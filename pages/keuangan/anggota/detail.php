...
<h1>Detail Data Keuangan Siswa & Guru</h1>
<hr>
        ...
        <form action="" method="post">
            <div class="input-group">
                <select name="detail" class="form-control" required>
                    <option value="">~~~ Pilih Username Admin / Guru~~~</option>
                    <?php 
...
<div class="col-sm-6 text-right mb-3">
    ...
    ?>
            <button onclick="window.location.href='?page=keuanganWargaDetail'" class="btn btn-success"><i class="fa fa-sync-alt"></i> Refresh</button>
</div>
</div>
...
<div class="row">
    <div class="col-sm-12 text-right">
        <a onclick="return confirm('Yakin ingin  menghapus semua data keuangan warga ini ? ');" href="?page=keuanganwarga&action=hapus&id=<?= $user->kode?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus Semua Data Keuangan <?= $user->username ?></a>
    </div>
</div>
<?php
                }}    
