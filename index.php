...
<html lang="en">
  ...
  <head>
    ...
    <title>
      <?php 
        ...
        if($page == "pengguna"){
          echo "Vn Keuangan - Pengguna";
        }else if($page == "keuangan"){
          echo "Vn Keuangan - Pribadi";
        }else if($page == "keuangananggota"){
          echo "Vn Keuangan - Anggota";
        }else if($page == "keuangananggotadetail"){
          echo "Vn Keuangan - Detail Keuangan Anggota";
        }else if($page == "laporankeuangan"){
          echo "Vn Keuangan - Laporan Keuangan";
        }else if($page == "info"){
          echo "Vn Keuangan - Ibra-Vincent Info";
        }else if($page == "smk3"){
          ...
          echo "SMA Negeri 45 Jakarta";
        }
        else if($page == "smk54"){
          echo "SMK Negeri 54 Jakarta";
        }
        else if($page == "smk1"){
          echo "SMK Negeri 1";
        }
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">Tabungan & Pengeluaran Siswa</a>
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <h6 class="dropdown-header text-info">Keuangan Pribadi :</h6>
            <a class="dropdown-item" href="?page=keuangan">Kelola Keuangan</a>
            <div class="dropdown-divider"></div>
            <?php if(@$_SESSION['admin']) {?>
            <h6 class="dropdown-header text-info">Keuangan Siswa :</h6>
        ...
        <div class="container-fluid">
          <?php
            ...
            if($page == ""){
              ...
              if($action == ""){
                include "pages/sekolah/smk3.php";
              }else {
                include "pages/404.php";
              }
            }
              ...
              if($action == ""){
                include "pages/sekolah/sma1.php";
              }else {
                include "pages/404.php";
              }
            }
              ...
              if($action == ""){
                include "pages/sekolah/sma4.php";
              }else {
                include "pages/404.php";
              }
            }
              ...
              if($action == ""){
                include "pages/sekolah/sma5.php";
              }else {
                include "pages/404.php";
              }
            }
              ...
              if($action == ""){
                include "pages/sekolah/sma7.php";
              }else {
                include "pages/404.php";
              }
            }
              ...
              if($action == ""){
                include "pages/sekolah/sma45.php";
              }else {
                include "pages/404.php";
              }
            }
              ...
              if($action == ""){
                include "pages/sekolah/smk54.php";
              }else {
                include "pages/404.php";
              }
            }
              ...
              if($action == ""){
                include "pages/sekolah/smk1.php";
              }else {
                include "pages/404.php";
              }
            }
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Tabungan & Pengeluaran Siswa ( SMP N 1 Jakarta )</span>
            </div>
          </div>
        </footer>
